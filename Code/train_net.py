...
register_coco_instances("coco_fire_train", {}, json_file=r"/root/autodl-tmp/datasets/coco/annotations/instances_train2017.json",
 image_root = r"/root/autodl-tmp/datasets/coco/train2017")
register_coco_instances("coco_fire_val", {}, r"/root/autodl-tmp/datasets/coco/annotations/instances_val2017.json",
 r"/root/autodl-tmp/datasets/coco/val2017")

# 设置类别
from detectron2.data import MetadataCatalog
MetadataCatalog.get("coco_fire_train").thing_classes = ['fire']
MetadataCatalog.get("coco_fire_val").thing_classes = ['fire']
##================ END =========================##
